...
const ArcShot = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white">
      ...
      <div className="p-8">
        <h1 className="text-3xl font-bold mb-4">Arc Shot Effect 🎥</h1>
        <p className="text-gray-300 max-w-3xl">
          The Arc Shot is a dynamic camera movement where the camera moves in a
          circular or semicircular path around the subject. This powerful
          cinematic technique helps reveal different angles of the subject while
        ...
        <div className="w-1/2 pr-4 flex flex-col">
          ...
          <div className="bg-gray-900 rounded-lg border border-gray-700 p-4">
            ...
            <ol className="text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <li>
                Try to maintain a consistent distance and height as you move
              </li>
              <li>Stop recording when you complete your arc movement</li>
            </ol>
          </div>
        </div>

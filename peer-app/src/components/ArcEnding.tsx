...
export const ArcEnding = ({ recordedVideoUrl, onReset }: Props) => {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log("ArcEnding component unmounting");
      if (timerRef.current) {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white p-8">
      {/* 제목 */}
      <h1 className="text-4xl text-center mb-8">Here is your Arc Shot</h1>
